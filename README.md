...
📓 **Jupyter Notebook (VS Code)** — Interactive environment for exploratory data analysis (EDA)
📊 **Power BI Desktop** — Advanced data modeling and interactive dashboard design

## 📐 Dashboard Features
📇 **6 Executive KPI Cards:** Total Customers, Churn Rate, Total Churned, MRR at Risk, CLV, and Avg Tenure.
📊 **Churn Driver Analysis:** Bar charts mapping churn rates by contract type, payment method, internet service, and tenure group.
📈 **Tenure Trends:** Line chart visualizing customer churn behavior over time.
🌡️ **Cohort Churn Heatmap:** Matrix visual analyzing churn by contract type and tenure.
🍩 **Revenue Leakage Insights:** Donut charts illustrating Monthly Revenue at Risk broken down by contract, internet service, and tenure.
📉 **Retention Benchmarks:** Detailed bar charts and matrix visuals mapping overall retention rates.
🎛️ **Interactive Slicers:** Global filtering by **Contract Type** for deep-dive exploration.

## 💡 Key Insights
🚨 **The Baseline:** The overall churn rate sits at **26.5%** — representing a loss of **1,869 out of 7,043** customers.
📜 **Contract Vulnerability:** Month-to-month customers churn at a staggering **42.7%**, compared to a tiny **2.8%** for those on two-year contracts.
💳 **Payment Friction:** Customers using electronic checks churn at **45.3%** — nearly **3x higher** than those on automatic payment methods.
⏳ **The Critical Window:** The first year is the deadliest; **47.7% of new customers churn within their first 12 months**.
💰 **High-Value Exposure:** Fiber optic customers generate the highest revenue, yet they account for **$118,979** of the total **$139,130 monthly revenue at risk**.
📉 **The Bottom Line:** While the average Customer Lifetime Value (CLV) is **$2,096**, the business is currently losing over **$1.6 million annually** to churn.
